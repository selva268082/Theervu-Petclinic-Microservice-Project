CREATE TABLE IF NOT EXISTS SUCCESS_STORIES (
  PERSON_ID INT,
  TYPE_OF_DISEASE VARCHAR(30),
  CONSTRAINT personId PRIMARY KEY (PERSON_ID)
);

CREATE INDEX IF NOT EXISTS idx_type_Of_Issue ON SUCCESS_STORIES (typeofdisease);
...
CREATE TABLE IF NOT EXISTS SUCCESS_STRY_DATA_FRMT (
  FORMAT_ID INT,
  FORMAT_TYPE VARCHAR(80),
  STATUS VARCHAR(80),
  PERSON_ID INT,
  FOREIGN KEY (person_id) REFERENCES SUCCESS_STORIES(person_id),
